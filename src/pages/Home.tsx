...
const employees = [
  {
    ...
    avatarSrc: `${import.meta.env.BASE_URL}avatars/glasses-icon.svg`,
    hoverLine: '让我先看看数据。',
    enabled: true,
  },
  {
    ...
    avatarSrc: `${import.meta.env.BASE_URL}avatars/compass-icon.svg`,
    hoverLine: '增长，总有突破口。',
    enabled: true,
  },
  {
    ...
    avatarSrc: `${import.meta.env.BASE_URL}avatars/question-icon.svg`,
